...
import { categoryImages, generalImages } from '../assets/images';

const categories = [
  { name: "SABONETES", image: categoryImages.sabonetes },
  { name: "DESENGRAXANTES", image: categoryImages.desengraxantes },
  { name: "COZINHA INDUSTRIAL", image: categoryImages.cozinha },
  { name: "LAVANDERIA", image: categoryImages.lavanderia },
  { name: "LIMPEZA GERAL", image: categoryImages.limpezaGeral },
  { name: "TRATAMENTO DE PISOS", image: categoryImages.pisos },
  { name: "PRODUTOS ESPECÍFICOS", image: categoryImages.especificos },
  { name: "SUA MARCA, NOSSA PRODUÇÃO", image: generalImages.marcaProducao }
];
