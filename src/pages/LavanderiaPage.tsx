...
const products = [
  {
    ...
    image: productImages.lavanderia.cetimAlvejanteClorado,
  ...
  },
  {
    ...
    image: productImages.lavanderia.cetimDetergenteEmPo,
  ...
  },
  {
    ...
    image: productImages.lavanderia.cetimPastaUmectante,
  ...
  },
  {
    ...
    image: productImages.lavanderia.cetimAmaciante,
  ...
  },
  {
    ...
    image: productImages.lavanderia.cetimDetergenteLiquido,
    ...
    <div className="bg-white">
      ...
      <section className="relative h-[700px] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src={productImages.lavanderia.hero} 
      ...
      <section className="py-24 bg-gray-50 border-y border-gray-100 relative overflow-visible">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                src={generalImages.introLavanderia}
