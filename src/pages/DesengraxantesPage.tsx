...
const products = [
  {
    ...
    image: productImages.desengraxantes.raylinDesengraxanteMultiuso,
  ...
  },
  {
    ...
    image: productImages.desengraxantes.raylinDesengraxanteMultiusoGf,
  ...
  },
  {
    ...
    image: productImages.desengraxantes.raylinDesengraxanteMultiusoLv,
  ...
  },
  {
    ...
    image: productImages.desengraxantes.raylinLimpezaPesada,
  ...
  },
  {
    ...
    image: productImages.desengraxantes.raylinLimpezaPesadaSe,
  ...
  {
    name: "Raylin DSE",
    image: productImages.desengraxantes.raylinDse,
  ...
  {
    name: "Raylin MSE-N",
    image: productImages.desengraxantes.raylinMseN,
  ...
  {
    name: "Raylin SNT",
    image: productImages.desengraxantes.raylinSnt,
  ...
  {
    name: "Multisolv-L",
    image: productImages.desengraxantes.multisolvL,
    ...
    <div className="bg-white">
      ...
      <section className="relative h-[700px] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src={productImages.desengraxantes.hero}
      ...
      <section className="py-24 bg-gray-50 border-y border-gray-100 relative overflow-visible">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                src={generalImages.introDesengraxantes}
