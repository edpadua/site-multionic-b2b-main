...
const products = [
  {
   ...
   image: productImages.cozinha.efficaxAluminium,
  ...
  {
    name: "Efficax CL",
    image: productImages.cozinha.efficaxCl,
  ...
  {
    name: "Efficax DT",
    image: productImages.cozinha.efficaxDt,
  ...
  {
    name: "Efficax SEC",
    image: productImages.cozinha.efficaxSec,
  ...
  {
    name: "Raylin D",
    image: productImages.cozinha.raylinD,
  ...
  },
  {
    ...
    image: productImages.cozinha.raylinDetergenteDesinfetante,
    ...
    <div className="bg-white">
      ...
      <section className="relative h-[700px] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src={productImages.cozinha.hero} 
      ...
      <section className="py-24 bg-gray-50 border-y border-gray-100 relative overflow-visible">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                src={generalImages.introCozinha}
