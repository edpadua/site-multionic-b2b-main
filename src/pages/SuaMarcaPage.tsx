          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-center my-6 h-36 md:h-44">
                  <img 
                    src={generalImages.aboutGallery[2]} 
                    alt="Envase" 
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-center my-6 h-36 md:h-44">
                  <img 
                    src={generalImages.aboutGallery[1]} 
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center justify-center my-6 h-36 md:h-44">
                  <img 
                    src={generalImages.aboutGallery[3]} 
      ...
      <section className="py-16 md:py-24 bg-white border-t border-gray-100">
        <div className="container-custom text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 items-center justify-items-center max-w-5xl mx-auto">
            <img 
              src={generalImages.clientLogos[0]} 
            ...
            />
            <img 
              src={generalImages.clientLogos[1]} 
              alt="Parceiro Multionic 2" 
              className="max-h-20 md:max-h-24 w-auto object-contain transition-transform duration-300 hover:scale-105"
              referrerPolicy="no-referrer"
            />
            <img 
              src={generalImages.clientLogos[2]} 
              alt="Parceiro Multionic 3" 
              className="max-h-20 md:max-h-24 w-auto object-contain transition-transform duration-300 hover:scale-105"
              referrerPolicy="no-referrer"
            />
            <img 
              src={generalImages.clientLogos[3]} 
